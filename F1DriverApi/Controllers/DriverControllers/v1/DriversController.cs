...
namespace F1DriverApi.Controllers.v1
{
  [ApiController]
  ...
  public class DriversController : ControllerBase
  {
    ...
    // GET api/drivers
    [HttpGet]
    public async Task<List<Driver>> Get(string driverName, string driverNationality, string currentTeam, int driverAge, int raceWins, int podiums, int careerPoints, int wDCChampionships)
    {
